        ...
        W: HasWindowHandle + HasDisplayHandle + std::fmt::Debug + Send + Sync + Clone + 'static,
    {
        ...
        let surface = if needs_new_context {
            ...
            *gpu_context.borrow_mut() = None;
            ...
            // recreate the context, preferring hardware but allowing software.
            // Software-only VMs must be able to recover too. If no adapter works,
            // the caller requests another frame and retries.
