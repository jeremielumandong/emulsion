...
pub fn binding(name: &str, keys: &str, ctx: Option<&str>) -> Option<KeyBinding> {
    make_binding!(name, keys, ctx;
        ...
        ShowEditor, DeleteNode, NewLayer, DuplicateNode, GroupNodes, Ungroup, RenameLayer, MergeLayers, MergeVisible, MoveNodeUp, MoveNodeDown,
        ToggleNodeVisible, Ask, ToolHand, ToolRotateView, RepeatFilter, ToolMove, ToolPen, ToolType, ToolVerticalType, ConvertToSmartObject, ConvertSmartToLayers, RasterizeLayer, ToolMarquee, ToolLasso,
